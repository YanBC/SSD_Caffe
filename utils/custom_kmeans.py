...
class KMeans():
    """
    KMeans algorithm. Variable and function names are modeled
    after scikit's implementation. But here we allows arbitrary
    distance metrics (you can define your own or choose one from 
